...
const CreateProfile = (props) => {
  ...
  const [customizationModalRefresh, setCustomizationModalRefresh] =
    useState(false);
  ...
  const setProfileBasedOnDBFetch = () => {
    ...
    if (
      getUserInfo("sign-up-finished") === false ||
  ...
  const copyToClipboard = async () => {
    ...
    Mixpanel.track("Copy Profile URL Clicked");
    ...
    if (
    ...
    ) {
      {
        ...
        if (endDateAfterStartDate) {
          ...
          Mixpanel.track("Profile Item Added", {
            "Profile Item Type": "Experience",
          });
        } else {
  ...
  const checkValidAccomplishment = async () => {
    if (
      ...
      Mixpanel.track("Profile Item Added", {
        "Profile Item Type": "Accomplishment",
      });
    } else {
  ...
  const [profileScreenBackgroundColor, setProfileScreenBackgroundColor] = useState(state.backgroundColor)

  useEffect(() => {
    setProfileScreenBackgroundColor(state.backgroundColor)
  }, [state.backgroundColor])

  return (
    <MixpanelConsumer>
      {(mixpanel) => (
        <div className="profileScreenContainer" style={{backgroundColor: profileScreenBackgroundColor}}>
          <div className="profileContentContainer">
            <div className="createScreenProfileHeader">
              <div className="topRightIconsContainer">
                ...
                <h1 style={{ color: "transparent" }}>Send Feedback</h1>
                <div>
                  <HiOutlinePencil
            ...
            >
              <p
                ...
                onClick={() => {
                  ...
                  setCustomizationModalRefresh(!customizationModalRefresh);
              ...
              <p
                className="settingsItems"
                // style={{ cursor: 'pointer' }}
                onClick={() => {logout(); setSettingsModalOpen(false)}}
              >
                Sign Out
              </p>
            </Modal>
          ...
          <CustomizationModal
            modalOpen={customizationModalOpen}
            refresh={customizationModalRefresh}
          />
          {/* Measurable Modal */}
          {/* Add Item Modals */}
          {/* Add Item Modals */}
